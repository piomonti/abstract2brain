...
os.chdir('/Users/ricardo/Documents/Projects/neurosynth_dnn/models')
net = torch.load('dcgan_architecture_doubleFilters.pth')
...
# for example:
getMapping(net, ['amygdala'])
getMapping(net, ['visual'])
